...
Download RStudio from [ttps://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/)
...
![](RStudio1.png) \## Your RStudio Window - Follow Along!
...
-   Then, hit the run button ![](runbutton.png)
...
-   **Comments** follow the pound/hash sign: `#` and can occur at the end of a line or on its own line
...
[http://github.com/rstudio/cheatsheets/blob/main/base-r.pdf](http://github.com/rstudio/cheatsheets/blob/main/base-r.pdf)
