...
- R 4.61 and RStudio 2026.08.0+195 are newest as of August 2026
...
[![](Let%20There%20Be.png){width="600"}](https://fonzi.ai/blog/vibe-coding-memes)
...
What is your experience coding with AI?
...
## Why Learn R Coding in 2026?

General principles:

- **Do not trust code (or any LLM output) that you do not have the skills to double-check**.

. . .

- Reporting statistical analyses (that are produced by code) that you do not understand is a form of **research misconduct**.

. . .

- **There is no one correct way to analyze data, and you don't know what you don't know.** LLMs will make decisions that responsible researchers should not outsource: missing data handling, methods selection (e.g., OLS vs. regularized regression; treating data as continuous vs. categorical), etc.

## Why Learn R Coding in 2026?

* Writing code uses a type of clear and systematic thinking. AI-generated code is often only as good as its prompts.

. . .

* AI-generated code tends to include functions, print statements, etc. that make your code less efficient (and really obviously unedited AI-generated). This code tends to be much **lengthier** than necessary.

. . .

* Once you've learned the basics, it is usually **faster**, **cheaper**, and **more environmentally friendly** to code yourself rather than to use AI, especially for relatively contained tasks like analyzing research data. 
...
A [2025 meta-analysis](https://doi.org/10.3390/computers14050185) of AI tools on learning computer programming found that **AI-assisted learning**:

* Reduced task completion time

* Improved student performance scores

* **Did not** improve conceptual understanding or learning success

* Was **context-dependent** in its benefits: risk of over-reliance and diminished problem-solving skills

* Was *perceived* as highly useful by students, but most studies focus on short-term outcomes

## Video

{{< video https://www.youtube.com/watch?v=HTUh0OO6Kmo width="100%" height="100%" >}}
...
1.  The high temperature in Central Park on July 2, 2026 was 100$^{\circ}$F. Save this number as an object named `july2_F`.

2.  Convert the temperature in #1 to $^{\circ}$C by calling the `aug1_F` object. Save the output as `july2_C`.

$$C = \frac{5}{9}(F-32)$$

3.  Print the value stored in `july2_C`.
...
- RStudio cheat sheets: [https://posit.co/resources/cheatsheets/](https://posit.co/resources/cheatsheets) and <https://rstudio.github.io/cheatsheets/contributed-cheatsheets.html>
...
- Learning Statistics with R textbook, chapters 3-8: <https://learningstatisticswithr.com/>
...
- **Quarto** is the next generation of R Markdown and may eventually replace R Markdown

::: callout-important
**Use Quarto for this class if you can**

- Use R Markdown if you can't get Quarto to work on your computer (Windows machines with ARM processors are known to have issues)
:::
...
3.  Save the document as a `.qmd` file to your Desktop
...
Now that you know some R basics, let's see where "vibe coding" can get you!

**Work in pairs**:

1. Download the data file at <http://leahmf.com/day1data.csv>

    * Two columns: X and Y

2. Use an LLM of your choice to obtain R code that tests for statistical significance

    * X is the independent variable; Y is the dependent variable

3. Share prompts, results, impressions