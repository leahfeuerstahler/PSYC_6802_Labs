...
- R 4.6.1 and RStudio 2026.08.0+195 are newest as of August 2026
...
2.  Convert the temperature in #1 to $^{\circ}$C by calling the `july2_F` object. Save the output as `july2_C`.
...
1. The data is located at <http://leahmf.com/day1data.csv>
